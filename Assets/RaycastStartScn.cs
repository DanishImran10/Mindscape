...
public class RaycastStartScn : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.DrawRay(ray.origin, ray.direction * 20000f, Color.red); // Visualize the ray
        if (turnOnRaycast)
        {
            if (Physics.Raycast(ray, out RaycastHit hit, 20000f, buttonLayer)) // Check if button is hit
            {
