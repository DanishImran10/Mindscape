...
public class QuizManager : MonoBehaviour
{
    ...
    IEnumerator PlayingAnimations()
    {
        ...
        if(current_Number_Of_Question < number_Of_Questions_To_Be_Displayed)
        {
            ...
            ReticlePointer.GetComponent<RaycastScript>().turnOnRaycast = true;      //turn on Raycasting
    ...
    void CheckAnswer(int selectedIndex)
    {
        ...
        ReticlePointer.GetComponent<RaycastScript>().turnOnRaycast = false;     //turn off Raycasting
